...
<head>
  ...
  {{
    ...
    "@graph": [
      ...
      {{
        "@type": "Article",
        "headline": "{np} Notenpunkte: Bedeutung, Schulnote und Dezimalnote",
    ...
    <section class="content-section">
      <div class="container">
        <article class="content-prose">
          <h1>{np} Notenpunkte: Bedeutung, Schulnote und Dezimalnote</h1>
...
.content-prose h1 { font-size: clamp(28px, 4vw, 36px); font-weight: 800; letter-spacing: -0.025em; margin-bottom: 18px; line-height: 1.2; color: var(--text); }
.content-prose h2 { font-size: clamp(24px, 3.5vw, 30px); font-weight: 800; letter-spacing: -0.02em; margin-bottom: 14px; margin-top: 32px; }
